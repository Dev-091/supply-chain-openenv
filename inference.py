...
# Required environment variables as per problem statement
API_BASE_URL = os.getenv("API_BASE_URL", "http://localhost:11434/v1")
MODEL_NAME = os.getenv("MODEL_NAME", "qwen2.5:14b-instruct") # Default for local Ollama
...
def run_task(client: OpenAI, task_id: str, seed: int = 42):
    ...
    try:
        ...
        log_end(success=False, steps=step_num, rewards=rewards)
